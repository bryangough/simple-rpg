ClickedObjectButtons = function(game, maingame, parent){
...
ClickedObjectButtons.prototype = Object.create(Phaser.Group.prototype);
ClickedObjectButtons.constructor = ClickedObjectButtons;
ClickedObjectButtons.prototype.setButton = function(x,y,imageup,imageactive,ref, clickevent){
...
ClickedObjectButtons.prototype.doInv = function(touchedSprite, pointer){
...
ClickedObjectButtons.prototype.disableAll = function(){
    this.disableButton(this.currentActive);
...
//
ClickedObjectButtons.prototype.enableButton = function(ref){
    if(ref==null)
        return;
    ref.up.visible = false;
    ref.active.visible = true;
}
ClickedObjectButtons.prototype.disableButton = function(ref){
    if(ref==null)
        return;
    ref.up.visible = true;
    ref.active.visible = false;    
